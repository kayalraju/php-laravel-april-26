...
$stmt = $pdo->prepare("SELECT * FROM products WHERE is_delete IS NOT NULL");
$stmt->execute();
    ...
    <table class="table table-bordered">
        ...
        <?php foreach ($products as $product): ?>
            <tr>
                ...
                <td>
                    <a href="action/restore.php?id=<?= $product['id'] ?>" class="btn btn-warning btn-sm">Restore</a>
                    <a href="action/permanentdelete.php?id=<?= $product['id'] ?>" class="btn btn-danger btn-sm"
                    onclick="return confirm('Are you sure ! delete data permanently?')"
                    > Permanent Delete</a>
